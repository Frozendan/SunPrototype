                    ...
                    return (
                      <div key={`${index}-${name}`} className="flex w-full items-center gap-x-2">
                        <div
                          ...
                          style={{
                            backgroundColor: payload?.[index]?.payload?.color || `hsl(var(--heroui-${color}-${(index + 1) * 200}))`,
                          }}
                        />
          ...
          {categories.map((category, index) => (
            <div key={index} className="flex items-center gap-2">
              <span
                ...
                style={{
                  backgroundColor: chartData[index]?.color || `hsl(var(--heroui-${color}-${(index + 1) * 200}))`,
                }}
              />
...
export type { CircleChartProps, ChartData };
